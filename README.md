...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
	...
	Name the containers to best describe what they do. It's not for looks, it's for practicality. The first time you run into 'container-two' and '#2', and you're the one who wrote that gibberish, you'll be really unhappy with yourself.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
	
	Display: block will take up all the width available to it and will cause the line to break while inline does the exact opposite.Inline can be used to style individual characters within text for added control, while block is better for wrapper layouts.
...
5. Explain why git is valuable to a team of developers.
	...
	Git allows devs to go back in time and see the process that took place, as well as dive into the project and access the code as it is written in that specific version. It also allows many devs to collaborate on the same project without interfering with or ruining each other's code.
